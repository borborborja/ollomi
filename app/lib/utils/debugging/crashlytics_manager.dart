...
class CrashlyticsManager {
  static final instance = CrashlyticsManager();
  ...
  Future<void> reportCrash(Object exception, StackTrace stackTrace, {Map<String, String>? userAttributes}) async => Logger.handle(exception, stackTrace);
