...
class AppLocalizationsMk extends AppLocalizations {
  ...
  String get backgroundCaptureBatteryWarning =>
      'Дозволи Ollomi да работи во позадина за да продолжи снимањето со исклучен екран.';

  @override
  String get phoneMicBackgroundUnavailable =>
      'Снимањето во позадина не е достапно. Држи го Ollomi отворен додека снимаш.';
}
