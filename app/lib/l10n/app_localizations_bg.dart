...
class AppLocalizationsBg extends AppLocalizations {
  ...
  @override
  String get chatBlockQuestion => 'Въпрос';

  @override
  String get chatBlockOpenInGoals => 'Отваряне в „Цели“';

  @override
  String get chatBlockOpenConversation => 'Отваряне на разговора';

  @override
  String get chatBlockOpenInMemories => 'Отваряне в „Спомени“';

  @override
  String get chatBlockUnavailable => 'Вече не е налично';
  ...
  @override
  String get deviceAliasTitle => 'Персонализирано име';

  @override
  String get deviceAliasDescription => 'Показва се в приложението вместо името на устройството по подразбиране.';

  @override
  String get deviceAliasHint => 'Omi CV1';

  @override
  String get deviceAliasSaved => 'Името на устройството е обновено';
  ...
  @override
  String get backgroundCaptureBatteryWarning => 'Разреши на Ollomi да работи във фонов режим, за да продължи записът при изгасен екран.';

  @override
  String get phoneMicBackgroundUnavailable => 'Фоновото записване не е налично. Дръж Ollomi отворен по време на запис.';
}
