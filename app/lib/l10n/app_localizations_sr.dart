...
class AppLocalizationsSr extends AppLocalizations {
  ...
  @override
  String get deviceAliasTitle => 'Прилагођено име';

  @override
  String get deviceAliasDescription => 'Приказује се у апликацији уместо подразумеваног имена уређаја.';

  @override
  String get deviceAliasHint => 'Omi CV1';

  @override
  String get deviceAliasSaved => 'Име уређаја је ажурирано';
  ...
  @override
  String get backgroundCaptureBatteryWarning => 'Дозволи Ollomi да ради у позадини како би снимање радило и са искљученим екраном.';

  @override
  String get phoneMicBackgroundUnavailable => 'Снимање у позадини није доступно. Држи Ollomi отворен током снимања.';
}
