...
class AppLocalizationsBe extends AppLocalizations {
  ...
  @override
  String get deviceAliasTitle => 'Уласная назва';

  @override
  String get deviceAliasDescription => 'Паказваецца ў праграме замест назвы прылады па змаўчанні.';

  @override
  String get deviceAliasHint => 'Omi CV1';

  @override
  String get deviceAliasSaved => 'Назва прылады абноўлена';
  ...
  @override
  String get backgroundCaptureBatteryWarning => 'Дазвольце Ollomi працаваць у фоне, каб запіс працягваўся з выключаным экранам.';

  @override
  String get phoneMicBackgroundUnavailable => 'Фонавы запіс недаступны. Трымайце Ollomi адкрытым падчас запісу.';
}
