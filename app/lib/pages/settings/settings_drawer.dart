...
class _SettingsDrawerState extends State<SettingsDrawer> {
  ...
  Widget _buildVersionInfoSection() {
    ...
    final displayText = buildVersion != null
  ...
  Future<void> _copyVersionInfo() async {
    final versionPart = buildVersion != null
        ? 'Omi AI ${version ?? ""} ($buildVersion)'
        : 'Omi AI ${version ?? ""}';
  ...
  List<_SearchableItem> _buildSearchableItems(BuildContext context) {
    ...
    const profileIcon = FaIcon(
      FontAwesomeIcons.solidUser,
      color: Color(0xFF8E8E93),
      size: 20,
    );
    const notifIcon = FaIcon(
      FontAwesomeIcons.solidBell,
      color: Color(0xFF8E8E93),
      size: 20,
    );
    const permIcon = FaIcon(
      FontAwesomeIcons.shieldHalved,
      color: Color(0xFF8E8E93),
      size: 20,
    );
    const memIcon = FaIcon(
      FontAwesomeIcons.brain,
      color: Color(0xFF8E8E93),
      size: 20,
    );
    const devIcon = FaIcon(
    ...
    final items = <_SearchableItem>[
      ...
      _SearchableItem(
        title: context.l10n.notificationFrequency,
        icon: notifIcon,
        onTap: goToNotifications,
      ),
      _SearchableItem(
      ...
      _SearchableItem(
        ...
        icon: intIcon,
        onTap: goToIntegrations,
      ),
      // --- Permissions ---
      _SearchableItem(
        title: context.l10n.permissions,
        icon: permIcon,
        onTap: goToPermissions,
      ),
      _SearchableItem(
      ...
      _SearchableItem(
        title: context.l10n.apiEnvironment,
        icon: devIcon,
        onTap: goToDeveloper,
      ),
      // --- What's New ---
  ...
  Widget _buildOmiModeContent(BuildContext context) {
    return Column(
      children: [
        _buildSettingsItem(
          title: 'Ollomi · ${context.l10n.serverUrl}',
          icon: const Icon(Icons.dns),
          onTap: () => Navigator.of(
            context,
          ).push(MaterialPageRoute(builder: (_) => const SelfHostPage())),
        ),
        _buildSettingsItem(
          ...
          onTap: () => Navigator.of(
            context,
          ).push(MaterialPageRoute(builder: (_) => const ImportAudioPage())),
        ),
          ...
          children: [
            ...
            _buildSettingsItem(
              ...
              onTap: () {
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => const LocalIntegrationsPage(),
                  ),
                );
              },
            ),
