...
class _SettingsDrawerState extends State<SettingsDrawer> {
  ...
  List<_SearchableItem> _buildSearchableItems(BuildContext context) {
    ...
    void goToIntegrations() =>
        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const LocalIntegrationsPage()));
        ...
        return Column(
          children: [
            _buildSettingsItem(
                ...
                onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => const SelfHostPage()))),
            _buildSettingsItem(
                title: context.l10n.importData,
                icon: const Icon(Icons.audio_file),
                onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => const ImportAudioPage()))),
