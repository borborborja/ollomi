...
/// storyboard on screen indefinitely — no crash, no UI, no diagnostic. A remote
/// session refresh can fail by never completing (rather than returning an
/// error), and a cached session would then make every subsequent launch hang on
/// this call.
///
...
///
/// Kept in its own library, free of backend and generated-env imports, so it is
